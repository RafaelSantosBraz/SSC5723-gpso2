...
#include <unistd.h>
#include <string.h>
#include <stdio_ext.h> //para usar a função de limpeza do buffer
...
int main (int argc, char *argv[])
{
    ...
    char buf[128]; //armazena a linha que será escrita no arquivo
    char op[] = "s"; // variável auxiliar para escrita no arquivo
    /*
